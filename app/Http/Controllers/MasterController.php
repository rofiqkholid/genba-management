            ...
            "data" => $data->map(function ($item, $key) use ($request, $canDelete) {
                ...
                return [
                    ...
                    "action" => '<div class="flex items-center justify-start gap-2">
                                ...
                                <button type="button" title="Formula" class="w-10 h-10 flex items-center justify-center rounded-xl bg-purple-50 text-purple-500 hover:bg-purple-100 hover:text-purple-600 transition-all duration-200"
