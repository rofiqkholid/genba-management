...
return new class extends Migration
{
    ...
    public function up()
    {
        // 1. Insert "KPI Unit" menu under "Data Master" (group_id = 6, sub_group_id = 95)
    ...
    {
        DB::table('t100_user_menus_permission')->where('id_menus', 122)->delete();
        DB::table('t100_menus')->where('id', 122)->delete();
    }
};
