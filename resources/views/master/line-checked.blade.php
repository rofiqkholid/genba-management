...
<div id="createModal" class="fixed inset-0 z-50 hidden">
    ...
    <div class="fixed inset-0 flex items-center justify-center p-4">
        <div class="bg-white rounded-xl w-full max-w-md transform transition-all">
            ...
            <form id="createForm" action="{{ route('master.line-checked.store') }}" method="POST">
                @csrf
...
<div id="editModal" class="fixed inset-0 z-50 hidden">
    ...
    <div class="fixed inset-0 flex items-center justify-center p-4">
        <div class="bg-white rounded-xl w-full max-w-md transform transition-all">
            ...
            <form id="editForm" action="{{ route('master.line-checked.update') }}" method="POST">
                @csrf
...
<script>
    $(document).ready(function() {
        var table = $('#lineCheckedTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('master.line-checked.table') }}",
                type: 'POST',
                data: function(d) {
                    d._token = "{{ csrf_token() }}";
    ...
    function executeDelete() {
        ...
        $.ajax({
            url: "{{ route('master.line-checked.delete') }}",
            type: "POST",
            data: {
                _token: "{{ csrf_token() }}",
                sys_id: id
